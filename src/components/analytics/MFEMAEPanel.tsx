...
import type { useMFEMAEStats } from '../../hooks/useMFEMAEStats';
import { usePLFormatter } from '../../hooks/usePLFormatter';
import MFEMAEScatterPlot from './MFEMAEScatterPlot';
import ExitStrategyChart from './ExitStrategyChart';

interface MFEMAEPanelProps {
  trades: Trade[];
  stats: ReturnType<typeof useMFEMAEStats>;
}
